...
```
docker push de.icr.io/cenit/smserver:5.7.0.0-001
docker push de.icr.io/cenit/smagent:5.7.0.0-001
```
...
| `server.log4jFormatMsgNoLookups` | This should be true by default to avoid exploitation of CVE-2021-44228 | `true` |
