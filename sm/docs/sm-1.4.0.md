...
- [7. Advanced](#7-advanced)
  ...
  - [7.4. Prepare SM for Monitoring of Mounted Logs](#74-prepare-sm-for-monitoring-of-mounted-logs)
...
| `serviceAccountName`                                          | Name of existing service account. Overridden by 'serviceAccountName' explicitly defined for worksload (like i.e. 'server.serviceAccountName').                                                                                                                                       | `""`                                                                                                                                                                                     |
...
| `db2TestInstance.serviceAccountName`                          | Name of existing service account. If unset, the namespace's default service account is used.                                                                                                                                                                                         | `""`                                                                                                                                                                                     |
...
| `sqlServerTestInstance.serviceAccountName`                    | Name of existing service account. If unset, the namespace's default service account is used.                                                                                                                                                                                         | `""`                                                                                                                                                                                     |
...
## 7.4. Prepare SM for Monitoring of Mounted Logs
